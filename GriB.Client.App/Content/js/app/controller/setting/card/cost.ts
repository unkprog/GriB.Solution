...
export namespace Controller.Setting.Card {
    export class Cost extends card.Controller.Setting.Card.Card {
        constructor() {
            super();
        }
        ...
        private typeCostIncome: number = 2;
...
vars.registerController("setting/card/cost", function (module: any): Interfaces.IController { return new module.Controller.Setting.Card.Cost(); });