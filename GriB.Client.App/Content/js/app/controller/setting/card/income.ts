...
export namespace Controller.Setting.Card {
    export class Income extends card.Controller.Setting.Card.Card {
        constructor() {
            super();
        }
        ...
        private typeCostIncome: number = 1;
...
vars.registerController("setting/card/income", function (module: any): Interfaces.IController { return new module.Controller.Setting.Card.Income(); });