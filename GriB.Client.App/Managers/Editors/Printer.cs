...
namespace GriB.Client.App.Managers.Editors
{
    public static class Printer
    {
        ...
        public static List<printer> GetPrinters(this Query query, int salepoint = 0)
        {
            List<printer> result = new List<printer>();
            query.Execute(cmdGet, new SqlParameter[] { new SqlParameter() { ParameterName = "@id", Value = 0 }, new SqlParameter() { ParameterName = "@name", Value = string.Empty }, new SqlParameter() { ParameterName = "@salepoint", Value = salepoint } }
            , (values) =>
            {
        ...
        public static printer GetPrinter(this Query query, int id)
        {
            ...
            query.Execute(cmdGet, new SqlParameter[] { new SqlParameter() { ParameterName = "@id", Value = id }, new SqlParameter() { ParameterName = "@name", Value = string.Empty }, new SqlParameter() { ParameterName = "@salepoint", Value = 0 } }
            , (values) =>
            {
